...
cq.exporters.export(result, r"E:\auto_detection_process\demo_output_v2\industrial_gear_sw_backend\output.step")
...
with open(r"E:\auto_detection_process\demo_output_v2\industrial_gear_sw_backend\output.metadata.json", "w", encoding="utf-8") as _f:
