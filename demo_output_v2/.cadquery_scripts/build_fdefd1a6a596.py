...
cq.exporters.export(result, r"E:\auto_detection_process\demo_output_v2\gear_spur_20t_m2_pa20\output.step")
...
with open(r"E:\auto_detection_process\demo_output_v2\gear_spur_20t_m2_pa20\output.metadata.json", "w", encoding="utf-8") as _f:
