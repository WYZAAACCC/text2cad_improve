...
result = run_canonical_gcad_from_files(
    canonical_json=r"E:/auto_detection_process/demo_output_v2/.generative_cad_graphs/gcad_2490fcb9d9a2.json",
    validation_seed_json=r"E:/auto_detection_process/demo_output_v2/.generative_cad_graphs/gcad_2490fcb9d9a2.validation.json",
