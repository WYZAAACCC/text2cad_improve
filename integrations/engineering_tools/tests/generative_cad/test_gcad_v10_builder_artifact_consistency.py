"""v1.0: builder artifact consistency — all required fields covered."""


class TestBuilderArtifactConsistencyV10:
    ...
    def test_builder_checks_canonical_graph_hash(self):
        import inspect
        from seekflow_engineering_tools.generative_cad import builder
        src = inspect.getsource(builder)
        assert "canonical_graph_hash mismatch" in src

    def test_builder_checks_validation_proof(self):
        import inspect
        from seekflow_engineering_tools.generative_cad import builder
        src = inspect.getsource(builder)
