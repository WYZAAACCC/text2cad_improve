...
ANSYS_TEMPLATE_SCHEMAS: dict[str, dict[str, Any]] = {
    ...
    "turbine_disc_rotational_thermal": {
        ...
        "parameters": {
            ...
            "bore_r_mm": {"type": "float", "default": 60.0, "min": 1},
            "hub_r_mm": {"type": "float", "default": 120.0, "min": 1},
            "web_r1_mm": {"type": "float", "default": 120.0, "min": 1},
            "web_r2_mm": {"type": "float", "default": 215.0, "min": 1},
            "rim_r_mm": {"type": "float", "default": 250.0, "min": 1},
            "hub_half_z_mm": {"type": "float", "default": 38.0, "min": 0.1},
            "web_half_z1_mm": {"type": "float", "default": 22.0, "min": 0.1},
            "web_half_z2_mm": {"type": "float", "default": 15.0, "min": 0.1},
            "rim_half_z_mm": {"type": "float", "default": 30.0, "min": 0.1},
        },
        "metrics": [
