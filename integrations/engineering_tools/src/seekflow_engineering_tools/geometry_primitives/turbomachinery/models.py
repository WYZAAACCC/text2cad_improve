...
AXISYMMETRIC_TURBINE_DISK = PrimitiveDefinition(
    ...
    parameters=[
        ...
        PrimitiveParameter(name="rim_slot_generation_method", type="str", required=False, default="single_clean_polygon"),
        PrimitiveParameter(name="rim_slot_profile_kind", type="str", required=False, default="symmetric_multistage_fir_tree"),
        PrimitiveParameter(name="rim_slot_topology_mode", type="str", required=False, default="clean_socket_cut"),
        PrimitiveParameter(name="rim_slot_min_segment_length_mm", type="float", unit="mm", required=False, default=0.35, min_value=0.0),
        PrimitiveParameter(name="rim_slot_corner_relief_mm", type="float", unit="mm", required=False, default=0.25, min_value=0.0),
        PrimitiveParameter(name="rim_slot_profile_clean_tolerance_mm", type="float", unit="mm", required=False, default=0.000001, min_value=0.0),
        PrimitiveParameter(name="rim_slot_reject_self_intersection", type="bool", required=False, default=True),
        PrimitiveParameter(name="rim_slot_reject_duplicate_points", type="bool", required=False, default=True),
