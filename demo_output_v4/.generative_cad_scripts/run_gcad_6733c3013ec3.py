...
result = run_canonical_gcad_from_files(
    canonical_json=r"E:/auto_detection_process/demo_output_v4/.generative_cad_graphs/gcad_91b94baf0ec2.json",
    validation_seed_json=r"E:/auto_detection_process/demo_output_v4/.generative_cad_graphs/gcad_91b94baf0ec2.validation.json",
