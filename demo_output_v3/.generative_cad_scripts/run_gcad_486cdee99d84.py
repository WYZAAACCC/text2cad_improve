...
result = run_canonical_gcad_from_files(
    canonical_json=r"E:/auto_detection_process/demo_output_v3/.generative_cad_graphs/gcad_911953be57e8.json",
    validation_seed_json=r"E:/auto_detection_process/demo_output_v3/.generative_cad_graphs/gcad_911953be57e8.validation.json",
