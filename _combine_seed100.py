"""Combine the 100 other-seed runs with the three corrected reruns."""
...
BASE = OUT / "other_seeds_100"
FIX = OUT / "other_seeds_fix"

REPLACE = {("T06", 5), ("T08", 3), ("T07", 10)}
...
def main() -> None:
    ...
    lines = [
        "# Other-Seed 100 Runs (T01-T10, seeds 0-7/9/10) - Final",
        "",
