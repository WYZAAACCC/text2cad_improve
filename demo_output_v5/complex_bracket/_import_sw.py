...
step = Path(r"E:/auto_detection_process/demo_output_v5/complex_bracket/output.step")
sldprt = Path(r"E:/auto_detection_process/demo_output_v5/complex_bracket/output.SLDPRT")
