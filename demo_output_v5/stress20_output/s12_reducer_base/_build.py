...
can = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s12_reducer_base/canonical.json')
val = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s12_reducer_base/validation_bundle.json')
stp = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s12_reducer_base/output.step')
met = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s12_reducer_base/output.metadata.json')
