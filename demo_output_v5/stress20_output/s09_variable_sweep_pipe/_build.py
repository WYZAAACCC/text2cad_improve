...
can = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s09_variable_sweep_pipe/canonical.json')
val = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s09_variable_sweep_pipe/validation_bundle.json')
stp = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s09_variable_sweep_pipe/output.step')
met = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s09_variable_sweep_pipe/output.metadata.json')
