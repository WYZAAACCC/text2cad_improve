...
stp = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s05_long_spring/output.step')
met = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s05_long_spring/output.metadata.json')
