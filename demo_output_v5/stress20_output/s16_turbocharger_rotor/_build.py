...
can = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s16_turbocharger_rotor/canonical.json')
val = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s16_turbocharger_rotor/validation_bundle.json')
stp = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s16_turbocharger_rotor/output.step')
met = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s16_turbocharger_rotor/output.metadata.json')
