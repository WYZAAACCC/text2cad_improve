...
can = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s07_cross_rib_box/canonical.json')
val = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s07_cross_rib_box/validation_bundle.json')
stp = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s07_cross_rib_box/output.step')
met = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s07_cross_rib_box/output.metadata.json')
