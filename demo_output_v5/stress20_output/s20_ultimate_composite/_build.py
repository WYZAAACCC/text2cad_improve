...
can = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s20_ultimate_composite/canonical.json')
val = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s20_ultimate_composite/validation_bundle.json')
stp = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s20_ultimate_composite/output.step')
met = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s20_ultimate_composite/output.metadata.json')
