...
can = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s03_dense_rib_plate/canonical.json')
val = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s03_dense_rib_plate/validation_bundle.json')
stp = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s03_dense_rib_plate/output.step')
met = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s03_dense_rib_plate/output.metadata.json')
