...
can = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s08_multi_step_shaft_all_features/canonical.json')
val = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s08_multi_step_shaft_all_features/validation_bundle.json')
stp = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s08_multi_step_shaft_all_features/output.step')
met = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s08_multi_step_shaft_all_features/output.metadata.json')
