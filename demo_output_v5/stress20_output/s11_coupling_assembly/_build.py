...
can = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s11_coupling_assembly/canonical.json')
val = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s11_coupling_assembly/validation_bundle.json')
stp = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s11_coupling_assembly/output.step')
met = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s11_coupling_assembly/output.metadata.json')
