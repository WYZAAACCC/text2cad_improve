...
can = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s10_shelled_ribbed_housing/canonical.json')
val = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s10_shelled_ribbed_housing/validation_bundle.json')
stp = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s10_shelled_ribbed_housing/output.step')
met = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s10_shelled_ribbed_housing/output.metadata.json')
