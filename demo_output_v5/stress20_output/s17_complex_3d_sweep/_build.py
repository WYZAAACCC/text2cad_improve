...
can = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s17_complex_3d_sweep/canonical.json')
val = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s17_complex_3d_sweep/validation_bundle.json')
stp = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s17_complex_3d_sweep/output.step')
met = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s17_complex_3d_sweep/output.metadata.json')
