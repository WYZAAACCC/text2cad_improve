...
can = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s13_pipe_system/canonical.json')
val = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s13_pipe_system/validation_bundle.json')
stp = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s13_pipe_system/output.step')
met = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s13_pipe_system/output.metadata.json')
