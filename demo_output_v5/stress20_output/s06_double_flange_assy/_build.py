...
can = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s06_double_flange_assy/canonical.json')
val = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s06_double_flange_assy/validation_bundle.json')
stp = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s06_double_flange_assy/output.step')
met = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s06_double_flange_assy/output.metadata.json')
