...
can = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s04_deep_hole_manifold/canonical.json')
val = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s04_deep_hole_manifold/validation_bundle.json')
stp = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s04_deep_hole_manifold/output.step')
met = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s04_deep_hole_manifold/output.metadata.json')
