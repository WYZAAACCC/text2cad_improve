...
can = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s14_bearing_housing_full/canonical.json')
val = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s14_bearing_housing_full/validation_bundle.json')
stp = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s14_bearing_housing_full/output.step')
met = Path(r'E:/auto_detection_process/demo_output_v5/stress20_output/s14_bearing_housing_full/output.metadata.json')
