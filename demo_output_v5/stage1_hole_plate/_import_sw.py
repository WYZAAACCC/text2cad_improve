...
step = Path(r"E:/auto_detection_process/demo_output_v5/stage1_hole_plate/output.step")
sldprt = Path(r"E:/auto_detection_process/demo_output_v5/stage1_hole_plate/output.SLDPRT")
