...
step = Path(r"E:/auto_detection_process/demo_output_v5/hole_plate/output.step")
sldprt = Path(r"E:/auto_detection_process/demo_output_v5/hole_plate/output.SLDPRT")
