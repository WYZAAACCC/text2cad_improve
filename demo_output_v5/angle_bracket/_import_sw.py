...
step = Path(r"E:/auto_detection_process/demo_output_v5/angle_bracket/output.step")
sldprt = Path(r"E:/auto_detection_process/demo_output_v5/angle_bracket/output.SLDPRT")
