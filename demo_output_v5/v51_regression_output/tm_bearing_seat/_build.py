...
can = Path(r'E:/auto_detection_process/demo_output_v5/v51_regression_output/tm_bearing_seat/canonical.json')
val = Path(r'E:/auto_detection_process/demo_output_v5/v51_regression_output/tm_bearing_seat/validation_bundle.json')
stp = Path(r'E:/auto_detection_process/demo_output_v5/v51_regression_output/tm_bearing_seat/output.step')
met = Path(r'E:/auto_detection_process/demo_output_v5/v51_regression_output/tm_bearing_seat/output.metadata.json')
