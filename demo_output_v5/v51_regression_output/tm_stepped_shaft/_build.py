...
can = Path(r'E:/auto_detection_process/demo_output_v5/v51_regression_output/tm_stepped_shaft/canonical.json')
val = Path(r'E:/auto_detection_process/demo_output_v5/v51_regression_output/tm_stepped_shaft/validation_bundle.json')
stp = Path(r'E:/auto_detection_process/demo_output_v5/v51_regression_output/tm_stepped_shaft/output.step')
met = Path(r'E:/auto_detection_process/demo_output_v5/v51_regression_output/tm_stepped_shaft/output.metadata.json')
