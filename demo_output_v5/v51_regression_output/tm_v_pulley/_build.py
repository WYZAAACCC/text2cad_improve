...
can = Path(r'E:/auto_detection_process/demo_output_v5/v51_regression_output/tm_v_pulley/canonical.json')
val = Path(r'E:/auto_detection_process/demo_output_v5/v51_regression_output/tm_v_pulley/validation_bundle.json')
stp = Path(r'E:/auto_detection_process/demo_output_v5/v51_regression_output/tm_v_pulley/output.step')
met = Path(r'E:/auto_detection_process/demo_output_v5/v51_regression_output/tm_v_pulley/output.metadata.json')
