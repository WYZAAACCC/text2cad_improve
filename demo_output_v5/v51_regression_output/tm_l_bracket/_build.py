...
can = Path(r'E:/auto_detection_process/demo_output_v5/v51_regression_output/tm_l_bracket/canonical.json')
val = Path(r'E:/auto_detection_process/demo_output_v5/v51_regression_output/tm_l_bracket/validation_bundle.json')
stp = Path(r'E:/auto_detection_process/demo_output_v5/v51_regression_output/tm_l_bracket/output.step')
met = Path(r'E:/auto_detection_process/demo_output_v5/v51_regression_output/tm_l_bracket/output.metadata.json')
