...
can = Path(r'E:/auto_detection_process/demo_output_v5/v51_regression_output/tm_roller/canonical.json')
val = Path(r'E:/auto_detection_process/demo_output_v5/v51_regression_output/tm_roller/validation_bundle.json')
stp = Path(r'E:/auto_detection_process/demo_output_v5/v51_regression_output/tm_roller/output.step')
met = Path(r'E:/auto_detection_process/demo_output_v5/v51_regression_output/tm_roller/output.metadata.json')
