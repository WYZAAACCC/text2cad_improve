...
can_path = Path(r"E:/auto_detection_process/demo_output_v5/test_model_output/t1_stepped_shaft/canonical.json")
val_path = Path(r"E:/auto_detection_process/demo_output_v5/test_model_output/t1_stepped_shaft/validation_bundle.json")
step_path = Path(r"E:/auto_detection_process/demo_output_v5/test_model_output/t1_stepped_shaft/output.step")
meta_path = Path(r"E:/auto_detection_process/demo_output_v5/test_model_output/t1_stepped_shaft/output.metadata.json")
