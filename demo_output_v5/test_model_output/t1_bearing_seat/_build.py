...
can_path = Path(r"E:/auto_detection_process/demo_output_v5/test_model_output/t1_bearing_seat/canonical.json")
val_path = Path(r"E:/auto_detection_process/demo_output_v5/test_model_output/t1_bearing_seat/validation_bundle.json")
step_path = Path(r"E:/auto_detection_process/demo_output_v5/test_model_output/t1_bearing_seat/output.step")
meta_path = Path(r"E:/auto_detection_process/demo_output_v5/test_model_output/t1_bearing_seat/output.metadata.json")
