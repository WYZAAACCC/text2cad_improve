...
can_path = Path(r"E:/auto_detection_process/demo_output_v5/test_model_output/t1_flange_cover/canonical.json")
val_path = Path(r"E:/auto_detection_process/demo_output_v5/test_model_output/t1_flange_cover/validation_bundle.json")
step_path = Path(r"E:/auto_detection_process/demo_output_v5/test_model_output/t1_flange_cover/output.step")
meta_path = Path(r"E:/auto_detection_process/demo_output_v5/test_model_output/t1_flange_cover/output.metadata.json")
