...
can_path = Path(r"E:/auto_detection_process/demo_output_v5/test_model_output/t2_spring/canonical.json")
val_path = Path(r"E:/auto_detection_process/demo_output_v5/test_model_output/t2_spring/validation_bundle.json")
step_path = Path(r"E:/auto_detection_process/demo_output_v5/test_model_output/t2_spring/output.step")
meta_path = Path(r"E:/auto_detection_process/demo_output_v5/test_model_output/t2_spring/output.metadata.json")
