...
can_path = Path(r"E:/auto_detection_process/demo_output_v5/test_model_output/t1_v_pulley/canonical.json")
val_path = Path(r"E:/auto_detection_process/demo_output_v5/test_model_output/t1_v_pulley/validation_bundle.json")
step_path = Path(r"E:/auto_detection_process/demo_output_v5/test_model_output/t1_v_pulley/output.step")
meta_path = Path(r"E:/auto_detection_process/demo_output_v5/test_model_output/t1_v_pulley/output.metadata.json")
